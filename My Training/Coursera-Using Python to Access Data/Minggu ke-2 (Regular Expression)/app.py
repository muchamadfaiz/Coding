# print("Greetings, My name is Muchamad Faiz")
# import re
...
# print("+", "one or more occurences")
# x = "Fr    om : Using the: character"
# y = re.findall('^F.+', x)
# print(y)
# print()

# print("?", "zero or one occurences")
# x = "Fr    om : Using the: character"
# y = re.findall('^F.?', x)
# print(y)
# print()

# print("*", "zero or more occurences")
# x = "Fr    om : Using the: character"
# y = re.findall('^F.*', x)
# print(y)

# # print("*", "zero or more occurences")
# x = "From muchamadfaiz@gmail.com Sat Jan 5 09:14:16 2022"
# y = re.findall('\S+@\S+', x)
# print(y)
# # print("*", "zero or more occurences")
# x = "From muchamadfaiz@gmail.com Sat Jan 5 09:14:16 2022"
...
# print("*", "zero or more occurences")
import re
x = "From muchamadfaiz@gmail.comSat Jan 5 09:14:16 2022"
y = re.findall("@([^ ]+)", x)
print(y)
...
# import re
# x = """
# file contains the actual data for your assignment - good luck!
...
# 8097 many reasons, ranging from making your living to solving
...
# to 6939 the 2767 hardware 7092 and we end up with a Personal Digital
...
# that 8947 human 5690 minds 3867 are designed to solve.  For a computer
...
# usually 5676 contains 2805 many 9760 different programs from many different groups of 
#  4600 programmers, each competing for your attention and interest.  They try 
...
# 8769 programmers are directly compensated because of your choice. 856
# 4992  5325
# If we think of programs as the creative output of groups of programmers,
# perhaps 3719 the 4833 following 2150 figure is a more sensible version of our PDA:
...
# 5700 When you first start, you will be both the programmer and the end user of 4883
...
# 356 that the CPU needs in a hurry.  The main memory is nearly as 5059
# fast as the CPU.  But the information stored in the main
# memory vanishes when the computer is turned off.

# 1456 Secondary Memory is also used to store 9882
...
# 9114 so we can talk about these different parts as we write our programs. 2361
...
# 3104 secondary memory, network, or the input/output devices. 5972
# 2882 
# You 122 need 302 to 5364 be the person who answers the CPU's What next? 
#  1192 question.  But it would be very uncomfortable to shrink you 
...
# 3174 In the rest of this book, we will try to turn you into a person
...
# 57 analysis problem and develop a program to solve the problem. 8512
...
# 4775 At some point you get your muse and see the patterns on your own 7529
...
# Words and sentences
# 9170 6828 3730
# Unlike 6691 human 1380 languages, 3118 the Python vocabulary is actually pretty small.
...
# 7530 your names for your variables, but you cannot use any of Python's 
# reserved words as a name for a variable.

# When 2205 we 6488 train 5532 a dog, we use special words like
#  9008 sit, stay, and fetch.  When you talk to a dog and
...
# 8052 assert    else      if        pass      yield 9769
...
# 3275 but for now we will focus on the Python equivalent of speak (in 
...
# is 3764 amazingly 6651 complex 4801 and powerful and very picky about 
#  1466 the syntax you use to communicate with it, Python is 5008
# not 6800 intelligent. 1917  848 You are really just having a conversation
...
# 6130 is a way for the creators of programs to express how the 8972
...
# 5801 Python is a high-level language intended to be relatively
...
# programmers 3544 to 7773 write 2434 in high-level languages like Python or JavaScript
#  and these translators convert the programs to machine language for actual
# execution by the CPU.

# 7204 Since machine language is tied to the computer hardware, machine language
# 7801 is not portable across different types of hardware.  Programs written in 
...
# 3624 is treating them as an ordered sequence of statements with later statements able 4870
...
# 7201 You can look at the actual source code for the Python interpreter by 2901
# 8970 going to www.python.org and working your way to their source code. 9074
# 2422 So Python is a program itself and it is compiled into machine code. 701
...
# 8597 which is called a script.  By 4491
